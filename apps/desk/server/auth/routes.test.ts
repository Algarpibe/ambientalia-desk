...
function app() {
  const sync = { backfillTickets: vi.fn(), backfillArchivedTickets: vi.fn(), syncRecent: vi.fn(), syncTicket: vi.fn(), syncConversations: vi.fn(), syncActivities: vi.fn(), syncTicketHistory: vi.fn(), backfillTicketHistory: vi.fn(), syncContacts: vi.fn() }
