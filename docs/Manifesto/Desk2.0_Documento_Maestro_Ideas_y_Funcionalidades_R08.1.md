AMBIENTALIA S.A.S.
Proyecto Desk 2.0 · Revisión R08.1
Documento maestro
...
Fuentes: Notion «CMMS (Desk 2.0) Ambientalia» — Ideas · IA · analisis-tickets · Reuniones (17/02, 19/02, 14/08, 20/08 y 21/08 de 2026) · Sesión de trabajo del 21/08/2026 sobre ejes de valor · Código de la aplicación Desk 2.0, commit a3a8f03 del 21/08/2026 · Hojas de mapeo de los cuatro flujos (02–16/02/2026) y Diccionario de Campos Tickets · Actas de Notion del 27/08/2026 y convocatoria del 03/09/2026
Fecha: 21 de agosto de 2026
Revisión: R08.1 — incorpora el acta del 27/08/2026, que ninguna revisión anterior recogía, y la convocatoria del 03/09/2026 (ver §1.2 y Anexos C.9 y C.10)
Contenido
...
1.2 Novedades de esta revisión (R08.1) PAGEREF _Toc239180936 \h 8
Lo que el acta del 27/08 resuelve PAGEREF _Toc239180937 \h 8
Lo que hay que mirar de frente PAGEREF _Toc239180938 \h 9
La sesión del 03/09 aún no se ha celebrado PAGEREF _Toc239180939 \h 9
...
C.10 — 03/09/2026 · Sesión convocada (aún no celebrada) PAGEREF _Toc239181083 \h 89
...
1.2 Novedades de esta revisión (R08.1)
...
Subdivisión de la orden de venta en subórdenes (OV-XXX_1, _2…), con un ticket por subservicio. Modifica el criterio de la reunión anterior.
...
La sesión del 03/09 aún no se ha celebrado
Lo que hay en Notion es la convocatoria con su orden del día, no un acta: el apartado de notas está vacío. Se recoge en C.10 porque dice qué se va a decidir, y los nueve entregables comprometidos el 27/08 figuran todos como pendientes.
...
Insumo pendiente
Queda por incorporar la reunión del 03/09/2026, «Checklist dinámico», citada por el revisor en M2.1 y M2.5 y no disponible al cerrar esta revisión.
...
5 transiciones. Esa fila no existe, ni en la hoja ni en el blueprint: Verificación no tiene salida.
...
M2.1
Conexión Zoho → PostgreSQL vía MCP ya operativa, con actualización cada tres minutos.
M11.1
...
Que nadie respondió: el motor dejó pasar la casilla vacía (M1.7)
...
Una orden de venta puede subdividirse en subórdenes (OV-XXX_1, _2…), con un ticket por subservicio.
27/08/2026
...
Conexión Zoho → PostgreSQL vía MCP
—
...
[AS-BUILT] La regla ya está implementada como campo obligatorio de la transición Habilitar Servicio, junto al serial. Lo que no está resuelto es qué ocurre operativamente si el equipo llega igualmente sin OV: hoy no hay estado provisional ni vía de recepción condicionada. Es el punto abierto nº 21.
...
Dos de los 38 pasos del mapa no son transiciones con botón: los escribe el servidor cuando ocurre algo con la remisión, sin que nadie pulse nada. Viven en apps/desk/server/db/estadoPorRemision.ts, no en el archivo de transiciones.
Desde
Hasta
Qué lo dispara
Ticket creado
...
Los 21 estados son alcanzables desde alguna de las dos entradas: 18 desde OV asignada, y desde Ticket creado los otros 20 —todos menos OV asignada—. No hay estados huérfanos.
...
Fuente: hoja DFequiponuevo030226 y blueprint «Ingreso equipo Nuevo» de Zoho. Corregido en la R05: la revisión anterior listaba seis transiciones y son cinco. La rama aún no está implementada en la aplicación.
Cinco transiciones, cinco estados.
Estado origen
Transición
Estado destino
Ingresado
...
Liberación
Finalizado
Dos caminos y un bucle: el normal (Ingresado → En Proceso → Finalizado), el desvío a Verificación, y el bucle de producto no conforme —se notifica, se analizan acciones y el equipo regresa a Ingresado— muy alineado con los procesos ISO que maneja Ambientalia.
Verificación no tiene salida [AS-IS — R05]
La revisión anterior de este apartado incluía una sexta fila, «Verificación → (aprobación implícita) → En Proceso», que no existe: ni en la hoja de mapeo, ni en el blueprint de Zoho, donde Verificación aparece como un nodo al que se llega y del que no sale ninguna flecha.
Estado en la R08. Pendiente de validar con Servicio Técnico cuál es el comportamiento real de esta etapa antes de definir sus salidas: puede ser que el retorno exista en la práctica y no esté modelado, o que la etapa se use como registro y no como paso del flujo. Punto abierto nº 38.
Es el quinto estado sin salida del sistema, y el más incómodo de los cinco: los cuatro de servicio técnico (M1.3.4) al menos tienen una transición que depende de un suceso externo. Éste no tiene ninguna. Un equipo nuevo enviado a verificación de calidad no puede volver al flujo, ni aprobado ni rechazado.
Corrección C12, punto abierto nº 38: definir las dos salidas que la etapa necesita —aprobada, que devuelve a En Proceso o pasa a Finalizado, y rechazada, que debería entroncar con el bucle de producto no conforme— antes de implementar esta rama. Es la ocasión de hacerlo bien: como el flujo aún no está construido, corregirlo aquí no cuesta nada.
Lo que este flujo aporta a los demás
Es el único de los cuatro que tiene una etapa de control de calidad explícita. La corrección C6 —introducir QA antes de la liberación en servicio técnico— puede modelarse sobre ella en lugar de diseñarla de cero, siempre que se resuelva primero su falta de salida.
...
[ABIERTO] Existe una puerta que no cierra. En buildTransitionPlan, la rama que procesa el checkbox sale antes de la comprobación de campo obligatorio: una casilla marcada como requerida y dejada sin marcar guarda false y la transición se ejecuta sin error.
El único checkbox obligatorio que sobrevive en las 34 etapas es «Liberación del ticket sin facturar» — precisamente el que deja salir un equipo de las instalaciones sin factura. Existe para que alguien afirme algo, y se pasa sin afirmar nada. Está registrado como M-2 en debt.md (M11.7) y el arreglo es una línea. Corrección C1, punto abierto nº 33.
...
[AS-BUILT] Los permisos por área viven en packages/shared/src/permissions.ts, en un solo sitio y no repartidos por la interfaz. Cada transición declara el área o áreas que pueden ejecutarla: Comercial, Servicio Técnico o Compras. Diez de las 34 transiciones son compartidas por dos áreas.
...
El cliente aprobó y el trabajo vuelve al taller. Ahí no hay puesto fijo al que mandarlo: hay que devolvérselo a quien diagnosticó ese ticket. + Director Técnico
...
[DECIDIDO] Se evoluciona de una lista lineal a un árbol de decisiones con ramas lógicas sí/no. [R08] Pendiente de incorporar las conclusiones de la reunión del 03/09/2026, «Checklist dinámico», que no estaba disponible al cerrar esta revisión.
...
3. La aplicación recorre el diagrama de flujo diagnóstico, con etapas, transiciones y puntos de control obligatorios. [R08] Pendiente de incorporar las conclusiones de la reunión del 03/09/2026, «Checklist dinámico».
...
Decisión: permitir la subdivisión de una orden de venta en subórdenes —formato OV-XXX_1, _2, _3— con un ticket asociado a cada subservicio, en lugar de exigir una orden de venta independiente por ticket. Modifica el criterio de la reunión anterior.
...
Ninguna de las tres encaja en un modelo de «una OV, un ticket», y las tres son habituales. Punto abierto nº 52.
...
[LOGRADO 21/08] Se conectó con éxito Zoho a la base de datos externa PostgreSQL mediante MCP. La información —tickets, órdenes de venta y contactos— se actualiza cada tres minutos.
...
Una línea: dar error cuando el campo es obligatorio y el valor no llega marcado.
...
Media
17
Base de datos PostgreSQL propia; Zoho en solo lectura (conexión MCP ya lograda)
M11
—
Muy alto
Alta
...
Media
20
Orden de venta obligatoria antes de la recepción del equipo
M1
①
Alto
Baja
...
M1.4 / M9
①
Un equipo enviado a verificación de calidad no puede volver al flujo. Corregirlo ahora no cuesta nada; después, sí.
Baja
Orden sugerido de ejecución: C1 (una línea, riesgo real) → C4, C5, C9 y C11 (bajo esfuerzo, desbloquean métricas) → C12 (gratis mientras la rama no exista) → C2 → C10 → C3.
...
Logro: se conectó Zoho a la base PostgreSQL mediante MCP; tickets, órdenes de venta y contactos se actualizan cada tres minutos.
...
Decisión: permitir la subdivisión de una orden de venta en subórdenes —formato OV-XXX_1, _2, _3— con un ticket asociado a cada subservicio, en lugar de exigir una OV independiente por ticket. Modifica el criterio de la reunión anterior.
...
Incorporada en la R08.1 como convocatoria, no como acta. A la fecha de cierre de esta revisión la sesión no se ha celebrado y el apartado de notas está vacío en el origen.
...
Gustavo / Alfonso
16
Transcribir las cinco imágenes de la página de KPIs. Parcialmente cubierto por el Anexo G, que documenta los trece indicadores calculados y sus fórmulas.
M7
Alfonso
17
...
Alfonso
21
Definir qué ocurre si llega un equipo sin orden de venta previa: ¿se rechaza o se abre en estado provisional?
M1
Alfonso / Gustavo
23
...
Dirección
33
Confirmar la corrección de debt.md M-2, y decidir si «Liberación del ticket sin facturar» debe seguir siendo un checkbox o convertirse en un campo que el motor sí pueda exigir.
M1.7 · C1
Alfonso / desarrollo
34
...
52
Modelar las variantes reales de orden de venta: OV separadas por mano de obra y por repuestos, OV globales por varios equipos, y tickets con varias OV asociadas. Ninguna encaja en «una OV, un ticket».
M4.4
Comercial / Alfonso
53
...
Alfonso
62
Decidir qué se hace con la capa as-built. El 27/08 se acordó retirar las referencias a lo construido por considerarlas ruido; la revisión posterior encargó expresamente la tabla de seguimiento del Anexo H. Son criterios opuestos y hay que elegir.
§1.10 · Anexo H
Alfonso
63
...
MCP
Model Context Protocol — vía por la que se conectó Zoho a la base PostgreSQL externa.
...
Conexión MCP a PostgreSQL, autocompletado por serial, OV previa a la recepción, menú visual de accesorios, interfaz que replica Zoho Desk, piloto Grimm EDM 180/280 y el módulo de digitalización del conocimiento. (El acta trató además el portal del empleado, retirado del alcance en la R06 — ver §1.2.)
...
Convocatoria, no acta: a la fecha de cierre la sesión no se ha celebrado. Aporta los nueve entregables pendientes, las ocho cuestiones que se someten a decisión y el criterio de MVP propuesto.
...
Artefacto de apoyo. El mapa visual del blueprint —diagrama completo, leyenda por área y fichas de los hallazgos— vive como artefacto interactivo bajo el título «Blueprint de Servicio Técnico — mapa de transiciones». Es la fuente gráfica de §M1.3 y se actualiza con cada auditoría del código.
Sobre la cobertura. De los cuatro vacíos que arrastraba este documento —el diccionario de campos, los dos diagramas comerciales y las cinco imágenes de la página de KPIs— la R05 cierra los tres primeros. Queda abierto el punto 16, aunque el Anexo G cubre buena parte de su contenido: los trece indicadores calculados y sus fórmulas.
...
Habilitar Servicio. Formaliza la activación del ticket.
42
Fecha Orden de Compra
Habilitar Servicio · Aprobación · Aprobación y S. Repuestos.
41
Fecha de Cotización
...
Construido y verificado. Coincide con la hoja del 16/02 en las 34 transiciones y con el código en las 38 filas del mapa (M1.3.7)
Ninguna en el grafo. Las diferencias son de comportamiento y están en H.3
Equipo nuevo
5 transiciones, 5 estados
No construido. Verificado sólo contra la hoja del 03/02 y el blueprint de Zoho
Verificación no tiene salida; hay que resolverlo antes de implementar (C12)
Soporte remoto
...
Pendiente. Confirmada la corrección; regla documentada en el as-is y perdida al implementar
Una línea
C2
...
Pendiente. Gratis mientras la rama no se construya
Baja
Ninguna de las doce está ejecutada a la fecha de corte. Cuatro cambiaron de definición o de alcance en esta revisión (C4, C5, C9, C11), lo que confirma que era pronto para ejecutarlas y tarde para seguir sin discutirlas.
...
Parcial: trece indicadores se calculan hoy sobre la tabla de tickets (Anexo G)
...
Construido. Conexión Zoho → PostgreSQL vía MCP operativa, actualización cada tres minutos
...
En evaluación. El demostrador permite lo contrario y tiene sentido operativo
...
Registrada la reunión del 03/09 como insumo pendiente.
M2.1
