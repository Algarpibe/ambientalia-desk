...
`valoresTransicion.ts`, `ticketService.ts:39` en `817eba3` (clientId), `por-entregar-es-espera` (color) e IV-11.
...
Los cinco de hoy son: `valoresTransicion.ts`, `ticketService.ts:39` en `817eba3` (clientId), `por-entregar-es-espera`
...
son: `ticketService.ts:39` en `817eba3` (clientId), `por-entregar-es-espera` (color), IV-11 e IV-12. Las narraciones de
...
aplica en `ticketService.ts:132`/`:134` vía `valoresConFechasDerivadas`, con los criterios 1-5, P-a, P-b
