...
*Eran **cuatro** hasta el 2026-09-16.* El quinto —la divergencia `orden_venta`/`salesorder_id` por
sincronización, última fila— lo registró la propuesta de `tercera-puerta-orden-venta` (IV-11), que lo
encontró al barrer las vías de escritura de la orden de venta y lo dejó **fuera de su alcance por
decisión de Gerencia**: se registra, no se corrige.
