...
### RQ-TZ-11 · Las fechas ya anotadas: el servidor las impone, no las propone
...
sugeriría sin que el servidor comprobara nada.)
...
### RQ-TZ-12 · El servidor impone las tres fechas derivadas
...
### RQ-TZ-13 · El día de un valor se calcula en la zona de negocio fijada, no en la del proceso
